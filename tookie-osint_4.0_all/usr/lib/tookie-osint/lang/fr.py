...
configOptionA = "[A] Nettoyer tookie-osint. (Supprime les fichiers temporaires)"
...
configOptionBMessage2 = (
    "NE DONNEZ PAS LES CLÉS SUIVANTES À QUICONQUE SAUF À UN DÉVELOPPEUR D'tookie-osint."
)
...
note = "Remarque ! "
path = "CHEMIN : ⤷ "
warning1 = "Beaucoup de sites web interdisent le téléchargement de leurs fichiers. Utilisation à vos propres risques."
warning2 = "L'utilisation du Webscraper est très lente."
warning3 = "Ceci est votre premier démarrage :D Vous devrez peut-être redémarrer tookie-osint pour utiliser tous les modules"
warning4 = "Vous utilisez une préversion d'tookie-osint !"
warning5 = "Veuillez entrer un objectif avant de continuer: "
...
status4 = "Retour à tookie-osint bientôt..."
...
error5 = "Impossible de trouver les fichiers nécessaires. Tentative de réinstallation d'tookie-osint"
...
wikiOption4 = "[4] tookie-osint sombre"
