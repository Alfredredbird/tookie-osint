...
def chart():
 ...
 with open(file_path, 'r') as file:
    ...
    for left, middle, right in zip(lines[:third_length], lines[third_length:2*third_length], lines[2*third_length:]):
    ...
    try:
        ...
        for item in fl:
            ...
            try:
                ...
                dlcount += 1.90001
                total_items = len(udfl)
                progress_bar_manual(dlcount,total_items, length=40, fill='█', print_end='\r')
            except FileNotFoundError:
